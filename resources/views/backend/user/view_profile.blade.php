                    ...
                    <div class="col-12">
                        ...
                        <div class="box box-widget widget-user">
                            ...
                            <div class="widget-user-header bg-black">
                                <h3 class="widget-user-username" style="color: gray">User Name: {{ $user->name }}</h3>

                                <a href="{{ route('profile.edit') }}" style="float: right;"
                                    class="btn btn-rounded btn-success mb-5"> Edit Profile</a>

                                <h6 class="widget-user-desc" style="color: gray">User Role: {{ $user->role }}</h6>
                                <h6 class="widget-user-desc" style="color: gray">User Email: {{ $user->email }}</h6>
